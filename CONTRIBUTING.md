# Contributing to YourNotes

Thank you for your interest in contributing to YourNotes! We appreciate your willingness to help improve and expand our application. By contributing, you help us make this project better for everyone.
...
*   **Fork the Repository:** Start by forking the [YourNotes](https://github.com/Bilal140202/YourNotes) repository to your GitHub account.
*   **Clone Your Fork:** Clone your forked repository to your local machine.
    *   **Set Up Upstream Remote:** Add the original YourNotes repository as an "upstream" remote. This allows you to sync your fork with the latest changes from the main project.
*   **Sync Your Fork:** Before starting any work, sync your fork with the upstream repository to ensure you have the latest code.

## 2. How to Contribute

There are several ways you can contribute to YourNotes:

*   **Reporting Bugs:** If you find a bug, please report it by opening a new [issue](https://github.com/Bilal140202/YourNotes/issues/new) on the GitHub repository. Provide as much detail as possible, including steps to reproduce the bug, expected behavior, and the environment in which the bug occurred (device model, Android version, app version).
*   **Suggesting Features:** Have an idea for a new feature or improvement? Open a new [issue](https://github.com/Bilal140202/YourNotes/issues/new) to discuss your suggestion. Explain the feature, its potential benefits, and how it might be implemented.
...
*   **Prerequisites:**
    ...
    *   **Android Studio:** Android Studio (latest stable) is highly recommended.
    *   **Gradle:** The project uses Gradle as its build tool. Gradle is bundled with Android Studio.
...
*   **Run the Application:** Once the project is imported, you should be able to build and run the application on an emulator or physical device.
...
*   **`scope` (optional):** The part of the codebase affected by the commit (e.g., `app`, `feature/note`, `core/data`, `build-logic`).
...
*   **`footer` (optional):** Can contain breaking changes information or references to GitHub issues. Use keywords like `Closes #<issue_number>` or `Fixes #<issue_number>`.

**Example:**
```
fix(reminder): resolve navigation crash when opening reminders list

The NavBackStack.pop() was emptying the entire back stack instead
of only the top entry, causing the app to crash.
Fixes #12
```
...
*   **Create a New Branch:** Create a new branch for your changes based on the latest `main` branch. Use a descriptive branch name (e.g., `fix/reminder-crash` or `feat/dark-mode`).
...
*   **Write Clear Commit Messages:** Follow the commit message guidelines above.
*   **Push Your Branch:** Push your branch to your fork on GitHub.
*   **Create a Pull Request:** Go to the [YourNotes repository](https://github.com/Bilal140202/YourNotes) on GitHub and create a new pull request from your branch.
*   **Provide Details:** In the pull request description, explain your changes, the problem they solve, or the feature they implement. Reference the relevant issue number using `#<issue_number>`.
...
We strive to create a welcoming and inclusive community. Please adhere to our [Code of Conduct](CODE_OF_CONDUCT.md).

## 9. Getting Help

If you have questions, need help, or want to discuss anything related to contributing, you can:

*   Open a [GitHub issue](https://github.com/Bilal140202/YourNotes/issues/new) with your question.

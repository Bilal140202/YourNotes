...
data class NotificationEntity(
     ...
     * This can be mapped to/from [com.yournote.model.NotificationPlace].
     */
    ...
    /**
     * Type of interval, corresponding to [com.yournote.model.NotificationInterval.index].
    ...
    /**
     * Type of interval end, corresponding to [com.yournote.model.IntervalEnd.index].
    ...
    /**
     * For [com.yournote.model.IntervalEnd.EndDate], stores the end date as epoch days.
     * Null if not applicable.
     */
    ...
    /**
     * For [com.yournote.model.IntervalEnd.NumberOfTimes], stores the number of occurrences.
     * Null if not applicable.
     */
